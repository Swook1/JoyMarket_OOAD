...
/*
  CustomerDashboardView - dashboard utama customer setelah login
  Nampilin info profile & saldo
  Ada menu browse produk, cart, edit profile, top up balance, logout
 */
public class CustomerDashboardView {
    ...
    private void initUI() {
        ...
        Label balanceLabel = new Label("Balance: Rp" + customer.getBalance());
