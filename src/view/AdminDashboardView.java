...
public class AdminDashboardView {
    ...
    // Deklarasi global biar bisa diakses method refresh
    ...
    private void initUI() {
        ...
        // Spacer biar tombol logout mojok kanan
    ...
    private VBox createProductTab() {
        ...
        // Kolom Category (Tambahan biar jelas)
        ...
        // PENTING: Load data awal pas tab dibuat
        refreshTable();
        ...
        updateBtn.setOnAction(e -> {
            ...
            if (result.startsWith("Success")) {
                ...
                refreshTable(); // <--- REFRESH TABEL DISINI BIAR STOCK UPDATE
                stockField.clear();
            } else {
                msgLabel.setStyle("-fx-text-fill: red;");
            }
    ...
    private void refreshTable() {
        // Mengambil list terbaru dari controller dan memasukkannya ke tabel
